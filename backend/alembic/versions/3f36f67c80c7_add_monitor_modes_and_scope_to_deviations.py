...
def upgrade() -> None:
    ...
    op.add_column("deviations", sa.Column("org_id", sa.String(length=200), nullable=False, server_default="default"))
    op.add_column("deviations", sa.Column("home_id", sa.String(length=200), nullable=False, server_default="default"))
    op.add_column("deviations", sa.Column("subject_id", sa.String(length=200), nullable=False, server_default="default"))
    ...
    op.create_table(
        ...
        sa.Column("room_id", sa.String(length=200), nullable=False, server_default="__GLOBAL__"),
        sa.Column("mode", sa.String(length=20), nullable=False, server_default="ON"),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
        sa.PrimaryKeyConstraint("org_id", "home_id", "subject_id", "monitor_key", "room_id", name="monitor_modes_pkey"),
    )
