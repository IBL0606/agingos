...
RULE_REGISTRY: Dict[str, RuleSpec] = {
    ...
    "R-004": RuleSpec(
        ...
        description="Prolonged bathroom presence",
        category="bathroom",
        version="v1",
    ),
    "R-005": RuleSpec(
        ...
        description="No bathroom activity in 24h (trend)",
        category="bathroom",
        version="v1",
    ),
    "R-006": RuleSpec(
        ...
        description="No livingroom daytime activity (trend)",
        category="activity",
        version="v1",
    ),
    "R-007": RuleSpec(
        ...
        description="Night wandering (room switches)",
        category="activity",
        version="v1",
    ),
    "R-008": RuleSpec(
        ...
        description="Door burst (repeated door events)",
        category="door",
        version="v1",
    ),
    "R-009": RuleSpec(
        ...
        description="Ingest stopped (liveness)",
        category="system",
        version="v1",
    ),
    "R-010": RuleSpec(
        ...
        description="Sensor stuck / room stuck",
        category="system",
        version="v1",
    ),
}
